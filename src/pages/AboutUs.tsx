      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div {...fadeInUp} className="bg-orange-50 p-8 rounded-xl">
            ...
            <motion.div {...fadeInUp} className="bg-red-50 p-8 rounded-xl">
              <div className="flex items-center mb-4">
      ...
      <section className="py-16 bg-gradient-to-r from-orange-600 to-red-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            {Object.entries(aboutUsContent.statistics).map(([key, value], index) => (
              <motion.div
                key={key}
                {...fadeInUp}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {aboutUsContent.recognitions.map((recognition, index) => (
              <motion.div
                ...
                {...fadeInUp}
                transition={{ delay: index * 0.1 }}
                className="bg-gradient-to-br from-orange-50 to-red-50 p-6 rounded-xl text-center"
              >
