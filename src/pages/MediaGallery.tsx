              ...
              {mediaGalleryContent.photos.albums.map((album) => (
                ...
                >
                  <div className="relative h-48 overflow-hidden">
                    <img
                      src={album.imageUrl}
                      alt={`${album.title} - ${album.category} - Bihar Purvanchal Samaj - ${album.photoCount} photos`}
                ...
                >
                  <div className="relative h-48 overflow-hidden">
                    <img
                      ...
                      alt={`${category.title} - Bihar Purvanchal Samaj video collection - ${category.videoCount} videos - ${category.duration}`}
