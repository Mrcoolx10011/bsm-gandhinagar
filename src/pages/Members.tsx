      ...
      <div key={nodeKey} className={`${depth > 0 ? 'ml-4' : ''}`}>
        ...
        <div
          className={`flex items-center justify-between py-3 px-4 rounded-lg cursor-pointer transition-all duration-200 ${
            depth === 0 
              ? 'bg-orange-50 border border-orange-200 font-semibold text-orange-900 mb-2' 
              : depth === 1
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <MapPin className={`w-4 h-4 ${depth === 0 ? 'text-orange-600' : 'text-gray-500'}`} />
                    ...
                    <div className="relative">
                      {member.image ? (
                        <img
                          src={member.image}
                          alt={member.name}
                          className="w-14 h-14 rounded-full object-cover ring-2 ring-gray-100 group-hover:ring-orange-200 transition-all duration-200"
                          onError={(e) => {
                        ...
                        <div className="w-14 h-14 rounded-full bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center ring-2 ring-gray-100 group-hover:ring-orange-200 transition-all duration-200">
        ...
        >
          <div className="text-center mb-4">
            {member.image ? (
              ...
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center mx-auto mb-3 ring-2 ring-gray-100">
          ...
          <div className="flex space-x-2">
            <a
              href={`tel:${member.phone}`}
              className="flex-1 bg-orange-100 text-orange-600 py-2 px-3 rounded-lg text-center hover:bg-orange-200 transition-colors text-sm font-medium"
              onClick={(e) => e.stopPropagation()}
            >
              Call
            </a>
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex space-x-3 pt-6">
                    <a
                      href={`tel:${selectedMember.phone}`}
                      className="flex-1 bg-orange-600 text-white py-3 px-4 rounded-lg text-center hover:bg-orange-700 transition-colors font-semibold"
                    >
